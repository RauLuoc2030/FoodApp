...
class AdminRecipes extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _AdminRecipesState();
}
...
class _AdminRecipesState extends State<AdminRecipes> {
  ...
  void initCategories() async {
    ...
    setState(() {
      widget.categories = categoryService.Categories;
    });
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        margin:
                                            EdgeInsets.fromLTRB(240, 3, 6, 12),
                                        child: Text(
                                          'Admin',
                                          style: GoogleFonts.getFont(
                                            'Be Vietnam Pro',
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius:
                                          BorderRadius.circular(26.0416660309),
                                    ),
              ...
              Container(
                margin: EdgeInsets.fromLTRB(24.7, 0, 29.7, 0),
                child: Row(
                        ...
                        Flexible(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              // var category = CategoryService().Categories[index];
                                ...
                                child: InkWell(
                                  onTap: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              AdminRecipes2(category: category,)),
                                    );
                                  },
                                  child: Stack(
                                    children: [
