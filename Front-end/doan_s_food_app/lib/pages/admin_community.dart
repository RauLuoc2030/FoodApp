...
class AdminCommunity extends StatefulWidget {
  @override
  _AdminCommunityState createState() => _AdminCommunityState();
}
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                margin: EdgeInsets.fromLTRB(10.8, 0, 10.8, 428),
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(builder: (context) => AdminCommunity1()), // Replace with your MenuAdmin widget
                                                );
                                              },
                                              child: Container(
