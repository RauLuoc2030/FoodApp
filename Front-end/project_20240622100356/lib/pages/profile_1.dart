...
class Profile1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(0, 161, 0, 0),
        child: Stack(
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 0, 0.6, 16.1),
                    child: Text(
                      'Yuuji',
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(5.2, 0, 5.2, 12),
                    decoration: BoxDecoration(
                      border: Border.all(color: Color(0xFF000000)),
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(7.8, 0, 1.1, 110.9),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Expanded(
                          child: Container(
                            margin: EdgeInsets.fromLTRB(0, 0, 22.3, 0.4),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: SizedBox(
                                      ...
                                      height: 30.6,
                                      child: SvgPicture.asset(
                                        'assets/vectors/kitchen_stove_5_x2.svg',
                                      ),
                                    ),
                                  ),
                                  Text(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: SizedBox(
                                    ...
                                    height: 34.7,
                                    child: SvgPicture.asset(
                                      'assets/vectors/hat_robe_6_x2.svg',
                                    ),
                                  ),
                                ),
                                Text(
