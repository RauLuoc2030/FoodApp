  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              height: 400.3,
              child: SvgPicture.asset(
                'assets/vectors/illustartion_1_x2.svg',
              ),
            ),
          ),
          Positioned(
    ...
    Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  margin: EdgeInsets.fromLTRB(6.3, 0, 0, 7.6),
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color(0xFFFFFFFF),
                    ),
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(0, 0, 6.3, 41.8),
                  child: Text(
                    'Đăng Nhập',
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(0, 0, 6.8, 29.9),
                  decoration: BoxDecoration(
                    border: Border.all(color: Color(0xFFFF785B)),
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(0, 0, 6.8, 26),
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color(0xFFFFFFFF),
                      borderRadius: BorderRadius.circular(8.6),
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(16.1, 13, 16.1, 13),
                      child: Text(
                        'Mật khẩu',
                        style: GoogleFonts.getFont(
                          'Be Vietnam Pro',
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(0, 0, 0.5, 35.7),
                  child: Opacity(
                    opacity: 0.6,
                    child: Text(
                      'Quên mật khẩu?',
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(0, 0, 0.5, 50.5),
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color(0xFFFF785B),
                      borderRadius: BorderRadius.circular(8.6),
                    ...
                    child: SizedBox(
                      width: 234.4,
                      child: Container(
                        padding: EdgeInsets.fromLTRB(0, 10.4, 22.4, 8.7),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.fromLTRB(0, 7.3, 0, 4.9),
                              child: Container(
                                decoration: BoxDecoration(
                                ...
                                child: Container(
                                  width: 20.8,
                                  height: 20.8,
                                  padding: EdgeInsets.fromLTRB(5.6, 5.6, 6.2, 6.2),
                                  child: SizedBox(
                                    width: 9,
                                    height: 9,
                                    child: SvgPicture.asset(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: SizedBox(
                                    ...
                                    height: 32.9,
                                    child: SvgPicture.asset(
                                      'assets/vectors/group_17863_x2.svg',
                                    ),
                                  ),
                                ),
                                Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: SizedBox(
                                    ...
                                    height: 25.1,
                                    child: SvgPicture.asset(
                                      'assets/vectors/super_g_1_x2.svg',
                                    ),
                                  ),
                                ),
                                Container(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(0, 19.5, 0, 9),
                          child: SizedBox(
                            width: 19.3,
                            height: 7.4,
                            child: SvgPicture.asset(
