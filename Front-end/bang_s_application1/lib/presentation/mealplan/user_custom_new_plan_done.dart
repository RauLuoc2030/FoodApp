...
import 'package:google_fonts/google_fonts.dart';
  ...
  class UserCustomNewPlanDone extends StatefulWidget {
  const UserCustomNewPlanDone({Key? key})
      : super(
  key: key,
  );
  @override
  UserCustomNewPlanDoneState createState() =>
      UserCustomNewPlanDoneState();
  static Widget builder(BuildContext context) {
  return ChangeNotifierProvider(
  create: (context) { ChangeNotifier();},
  child: UserCustomNewPlanDone(),
  );
  }
  }
  class UserCustomNewPlanDoneState
  extends State<UserCustomNewPlanDone> {
  @override
  void initState() {
  super.initState();
  }
